...
const LANG = {
  1:{ name:"As Visibility Shifts", tension:"Visibility ↔ Impact",
    ...
    "1":"Your default is to move closer to the work so your judgment is directly shaping the outcome. You trust what you can see and influence directly. This reflects a belief that staying close is what ensures the work is done right, and a tendency to step into the role of the one who makes sure the work is right. The cost is that ownership doesn't fully move. The work stays tied to you, and others don't fully take it on.",
    "2a":"Your default is to structure the work so it can move without you. You rely on roles, processes, and clear expectations to carry the outcome forward. This reflects a belief that the right structure is what holds the work together, and a tendency to step into the role of the one who makes sure it's set up to run as designed. The cost is that the structure can become limiting. The work follows the system, even when the situation requires something different.",
  ...
  2:{ name:"As Certainty Fades", tension:"Correctness ↔ Transparency",
    ...
    "1":"Your default is to move toward a conclusion. You work to determine what to do and move on it with conviction. This reflects a belief that a clear answer is what the situation requires, and a tendency to step into the role of the one who provides it. The cost is that the conclusion can come before the thinking is fully worked through. You move forward with confidence, but the reasoning may not yet support the certainty you're projecting.",
    "2a":"Your default is to build out the reasoning before committing to a conclusion. You slow the process down, name assumptions, and make sure the analysis is complete. This reflects a belief that running the right process is how sound decisions are made, and a tendency to step into the role of the one who makes sure the process has been fully run. The cost is that the analysis can continue when the situation requires a decision. The reasoning gets stronger, but the process itself can become the obstacle.",
  ...
  3:{ name:"As Control Decreases", tension:"Direct Control ↔ System Trust",
    ...
    "1":"Your default is to step back into the work when the outcome still reflects on you. You move closer so your judgment is directly shaping what gets delivered. This reflects a belief that since you're accountable, you need to be in it, and a tendency to step into the role of the one who makes sure the work meets the standard because it's on you. The cost is that ownership doesn't fully transfer, and others have less room to use their own judgment.",
    "2a":"Your default is to tighten the structure around the work as your direct control decreases. You put clearer roles, checkpoints, and expectations in place so the work can be tracked and held without you stepping back in. This reflects a belief that clear roles and processes are what keep accountability from slipping, and a tendency to step into the role of the one who makes sure the structure keeps the work on track. The cost is that people start following the process instead of taking ownership of what the situation actually requires, and accountability can look held even when no one is truly owning the outcome.",
  ...
  4:{ name:"As Priorities Diverge", tension:"Your People ↔ The Whole",
    setup:"PLACEHOLDER — to be written in next session.",
    "1":"PLACEHOLDER — Execution Mode portrait for As Priorities Diverge to be written in next session.",
    "2a":"PLACEHOLDER — Orchestration Mode portrait for As Priorities Diverge to be written in next session.",
    "2b":"PLACEHOLDER — Navigation Mode portrait for As Priorities Diverge to be written in next session.",
    "3":"PLACEHOLDER — Integration Mode portrait for As Priorities Diverge to be written in next session."
  },
  5:{ name:"As the Moment Intensifies", tension:"Reaction ↔ Curiosity",
    setup:"PLACEHOLDER — to be written in next session.",
    "1":"PLACEHOLDER — Execution Mode portrait for As the Moment Intensifies to be written in next session.",
    "2a":"PLACEHOLDER — Orchestration Mode portrait for As the Moment Intensifies to be written in next session.",
    "2b":"PLACEHOLDER — Navigation Mode portrait for As the Moment Intensifies to be written in next session.",
    "3":"PLACEHOLDER — Integration Mode portrait for As the Moment Intensifies to be written in next session."
  }
};
