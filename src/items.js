...
const ITEMS_SOURCE = [
  ...
  ["D1-Q1", 1, 1, "forced",
    ...
    ["I'm glad it went well. I still find myself wanting to have been more directly involved. Staying close to the work is how I know the outcome is right.",
     "I follow up with the manager to understand how it came together and whether the approach was carried out as intended.",
     "I pay attention to whether my role in the work is being understood accurately.",
     "I pay attention to whether the thinking behind it held up without me there—whether it was clear and strong enough to carry on its own."],
  ...
  ["D1-Q3", 1, 3, "forced",
    ...
    "Select the response MOST like you and LEAST like you",
    ["I'm glad it worked, but I find myself wanting to have been more directly involved. Staying close to the work is how I make sure the outcome reflects what I intended.",
     ...
     "That's the point. If it held without me, the thinking was strong enough. I'm more interested in what that says about the quality of the thinking than staying connected to the outcome."],
    ["outcome", "process", "identity", "system"]],
  ...
  ["D1-Q5", 1, 5, "paired",
    null,
    "You offer a direction in a leadership discussion, and the group moves forward with a different approach. Which statement resonates more with your experience?",
  ...
  ["D2-Q6", 2, 1, "forced",
    ...
    ["My first instinct is to clarify the conclusion. If the takeaway wasn't clear, I want to restate it so there's no confusion about where I stand.",
     ...
     "I look at the assumptions and logic underneath what I said and examine where they didn't hold or translate."],
    ["outcome", "process", "identity", "system"]],
  ...
  ["D2-Q10", 2, 5, "paired",
    null,
    "A decision you shaped is being questioned, and the group is split on what to do next. Which statement resonates more?",
  ...
  ["D3-Q11", 3, 1, "forced",
    ...
    "Select the response MOST like you and LEAST like you",
    ["My first instinct is to step back in. I can see what needs to happen to get it back on track, and the outcome still reflects on my judgment.",
  ...
  ["D3-Q12", 3, 2, "single",
    ...
    "Which response is most like you?",
    ["I step in to drive the decision. If ownership isn't clear, I take it. That's what moving things forward requires.",
     ...
     "I'm paying attention to how stepping in will land. Reading that correctly is how I maintain authority and move things forward effectively.",
  ...
  ["D3-Q13", 3, 3, "forced",
    ...
    ["My first instinct is to step in and clarify what should stay in place. If the approach is working, I want that to be clear before anything moves.",
     ...
     "I'm thinking about how I engage. Being open to the question and reading how my response lands matters as much as what I say.",
  ...
  ["D3-Q15", 3, 5, "paired",
    null,
    "Someone on your team makes a decision you wouldn't have made, and it's already in motion. Which resonates more?",
  ...
  ["D4-Q17", 4, 2, "single",
    ...
    "Which response is most like you?",
    ["I represent my team directly and make sure their perspective and impact are clearly understood, even if the final decision doesn't change.",
  ...
  ["D4-Q20", 4, 5, "paired",
    null,
    "You're in a leadership discussion where a decision will benefit the organization but create real strain for your team. Which resonates more?",
  ...
  ["D5-Q21", 5, 1, "forced",
    ...
    ["I respond directly. I clarify my position and move the conversation toward resolution so it stays focused.",
     ...
     "I step back and adjust how I'm engaging. Calibrating my tone and framing in the moment is how I keep the interaction productive.",
  ...
  ["D5-Q23", 5, 3, "forced",
    ...
    "Select the response MOST like you and LEAST like you",
    ["I stay focused on the outcome and keep the conversation moving. The frustration is there, but it doesn't change what needs to happen.",
     ...
     "I adjust how I'm coming across. Staying composed under pressure is a skill, and I use it.",
  ...
  ["D5-Q25", 5, 5, "paired",
    null,
    "A conversation becomes tense, and there's pressure to either resolve it quickly or stay with what's coming up. Which resonates more?",
